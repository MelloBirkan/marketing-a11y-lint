...
export const metadata: Metadata = {
  title: 'Pricing',
  description:
    'Companies all over the world have closed millions of deals with A11Y-Lint. Sign up today and start selling smarter.',
}
...
const tiers = [
  {
    ...
    highlights: [
      ...
      { description: 'A11Y-Lint AI integrations', disabled: true },
  ...
  },
  {
    ...
    highlights: [
      ...
      { description: 'A11Y-Lint AI integrations' },
  ...
  return (
    <Container className="mt-16">
      ...
      <Lead className="mt-6 max-w-3xl">
        Companies all over the world have closed millions of deals with A11Y-Lint.
            ...
            <figure className="mx-auto flex max-w-xl flex-col gap-16 max-lg:text-center">
              <blockquote>
                <p className="relative text-3xl tracking-tight text-white before:absolute before:-translate-x-full before:content-['“'] after:absolute after:content-['”'] lg:text-4xl">
                  Thanks to A11Y-Lint, we&apos;re finding new leads that we never
              ...
              <figcaption className="mt-auto">
                ...
                <p className="text-sm/6 font-medium">
                  <span className="bg-linear-to-r from-[#CC7B08] from-28% via-[#E14775] via-70% to-[#7058BE] bg-clip-text text-transparent">
